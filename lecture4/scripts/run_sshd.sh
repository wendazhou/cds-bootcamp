...
$SSHD_PATH -f /dev/null -p $SSHD_PORT -h $SSH_KEY_DIR/ssh_host_rsa_key -h $SSH_KEY_DIR/ssh_host_ecdsa_key -o PermitUserEnvironment=yes -o PidFile=~/.ssh/container_sshd_pid
